...
\section{Work\\Experience}
	...
	\begin{itemize}
		\item Tracked proprietary stats to supplement standard NBA statistics. %Charted the stats alongside play-by-play data.
	\end{itemize}
...
\section{Coursework, \\ Languages, \\ and Tools} 
	% \textbf{Skills} \vspace{1mm}\\\vspace{0.5mm}
	% if need more space, put the subtitles (Coursework, Lang, Tools) on the line with the bullet. 
	\textbf{Coursework} \
	\begin{itemize}
	...
	\textbf{Languages} \
	\begin{itemize}
		\item Python (Pandas, NumPy, scikit-learn), R (Tidyverse, ggplot2), SQL (PostgreSQL, Redshift), Git %, Bash %, Java %CSS, HTML %, Java % PyTorch, Flask, Jinja, Plotly
	\end{itemize} 
	\textbf{Tools} \
	\begin{itemize}
